...
public class Activity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (list.equals("Rock")) {
            ...
            displaytxt3.setText(String.valueOf("50.0"));
        }
        ...
        if ((list.equals("Rock") && xv <= 3240.0) || (list.equals("Soft Rock") && xv <= 440.0) || (list.equals("Coarse Sand") && xv <= 440.0) || (list.equals("Medium Sand") && xv <= 245.0) || (list.equals("Fine Sand") && xv <= 440.0) || (list.equals("Soft Shell") && xv <= 100.0) || (list.equals("Soft Clay") && xv <= 100.0) || (list.equals("Very Soft Clay") && xv <= 50.0)){
            ...
            if ((list.equals("Rock") && xv <= 3240.0)){
                displaytxt5.setText("This Soil is capable of bearing 330 tons of weight in atmost 67668 Square Foot");

            } else if ((list.equals("Soft Rock") && xv <= 440.0)){
                displaytxt5.setText("This soil is capable of bearing 44 tons of weight atmost 9189 Square Foot");
            } else if ((list.equals("Coarse Sand") && xv <= 440.0) ){
                displaytxt5.setText("This soil is capable of bearing  44 tons of weight in atmost 9189 Square Foot");

            } else if ((list.equals("Medium Sand") && xv <= 245.0) ){
                displaytxt5.setText("This soil is capable of bearing  24 tons of weight in atmost 5116 Square Foot");
            } else if ((list.equals("Fine Sand") && xv <= 440.0) ) {
                displaytxt5.setText("This soil is capable of bearing 44 tons of weight in atmost 9189 Square Foot");

            } else if ((list.equals("Soft Shell") && xv <= 100.0)) {
                displaytxt5.setText("This soil is capable of bearing 10 tons of weight in atmost 2088 Square Foot");
            } else if ((list.equals("Soft Clay") && xv <= 100.0)) {
                displaytxt5.setText("This soil is capable of bearing 10 tons of weight in atmost 2088 Square Foot");

            } else if ((list.equals("Very Soft Clay") && xv <= 50.0)) {
                displaytxt5.setText("This soil is capable of bearing 5 tons of weight in atmost 1044 Square Foot");
            }
